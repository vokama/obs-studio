...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
	!insertmacro MUI_DESCRIPTION_TEXT ${SecCore} "Основные файлы VK Games"
	!ifdef FULL
		!insertmacro MUI_DESCRIPTION_TEXT ${SecPlugins} "Плагины"
		!insertmacro MUI_DESCRIPTION_TEXT ${SecPlugins_Browser} "Browser плагин (источник, который можно использовать для отображения веб-страниц: чатов, уведомлений о пожертвованиях)"
		!ifdef REALSENSE_PLUGIN
